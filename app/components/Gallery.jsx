    ...
    return (
      <Row id="gallery">
        <Col md={12} sm={12} xs={12}>
          <Well>
            <p>Obývateľné su dve podlažia s celkovou kapacitou pre 11 osôb.
            ...
            na prvé poschodie, kde sú dve izby o kapacite 4 a 3 osoby a WC s umývadlom. Na druhom
            poschodí sú ďalšie dve izby o kapacite 2 a 2 osoby. Vykurovanie je riešené krbom a
